...
public class ModSounds {
    ...
    public static final SoundEvent MUSIC_DISC_1 = registerSoundEvent("music_disc_1");
    public static final SoundEvent MUSIC_DISC_2 = registerSoundEvent("music_disc_2");
    ...
    public static SoundEvent registerSoundEvent(String name) {
        Identifier id = new Identifier(Kicosidea.MOD_ID, name);
        return Registry.register(Registries.SOUND_EVENT, id, SoundEvent.of(id));
    }

    public static void registerSounds() {
        Kicosidea.LOGGER.info("Registering Sounds for " + Kicosidea.MOD_ID);
    }
}
